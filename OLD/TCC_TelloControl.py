...
def update_hud(hud, drone, flight_data):#Atualiza apenas as informações na tela do pygame
    ...
    #pygame.display.update(overlay.get_rect()) #Atualiza apenas as informações na tela do pygame

    # filename = '%s/Pictures/tello-%s.jpg' % (os.getenv('HOME'), datetime.datetime.now().strftime(date_fmt))
